...
class PlexData():
    ...
    def __init__(self, path, engine):
        ...
        self.get = self.engine.get
        self._grps = None
        self._expected_input_cols = ['RawFile', 'Date', 'Bug / Prep Method / seq name',
                    'Peptide Sample Name', 'Injection volume (ul)', 'MS method',
                    'Column used', 'Nr. Runs on Column', 'F / NF', 'Data folder', 'notes',
                    'CHECK', 'TIC', 'MQ proteins', 'MS1 ', 'MS2 ', 'MS3', 'Peptides',
